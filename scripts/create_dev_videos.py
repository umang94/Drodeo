...
def main():
    ...
    # Allow input and output directories to be passed as positional arguments
    parser.add_argument('source_dir', nargs='?', default=None, help='Source directory (optional, positional)')
    parser.add_argument('target_dir', nargs='?', default=None, help='Target directory (optional, positional)')
    
    args = parser.parse_args()
    
    # Use positional arguments if provided, otherwise use named arguments
    if args.source_dir:
        args.input_dir = args.source_dir
    if args.target_dir:
        args.output_dir = args.target_dir
